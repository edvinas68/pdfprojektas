...
<div class="bg-gray-200 bg-opacity-25 grid grid-cols-1 md:grid-cols-2">
    ...
    <div class="p-6 border-t border-gray-200">
        <div class="flex items-center">
        <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#808080" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="w-8 h-8 text-gray-400"><circle cx="12" cy="12" r="5"></circle><line x1="12" y1="1" x2="12" y2="3"></line><line x1="12" y1="21" x2="12" y2="23"></line><line x1="4.22" y1="4.22" x2="5.64" y2="5.64"></line><line x1="18.36" y1="18.36" x2="19.78" y2="19.78"></line><line x1="1" y1="12" x2="3" y2="12"></line><line x1="21" y1="12" x2="23" y2="12"></line><line x1="4.22" y1="19.78" x2="5.64" y2="18.36"></line><line x1="18.36" y1="5.64" x2="19.78" y2="4.22"></line></svg>
            <div class="ml-4 text-lg text-gray-600 leading-7 font-semibold"><a href="{{ url('AP_atostogos') }}">Apmokamos atostogos</a></div>
        </div>

        <div class="ml-12">
            <div class="mt-2 text-sm text-gray-500">
                Apmokamų atostogų prašymo/įsakymo dokumentų generavimas.
            </div>
            <a href="{{ url('AP_atostogos') }}">
                <div class="mt-3 flex items-center text-sm font-semibold text-indigo-700">
                        <div>Pildyti paraišką</div>
    ...
    <div class="p-6 border-t border-gray-200 md:border-l">
        <div class="flex items-center">
        <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#808080" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="w-8 h-8 text-gray-400"><path d="M23 12a11.05 11.05 0 0 0-22 0zm-5 7a3 3 0 0 1-6 0v-7"></path></svg>
            <div class="ml-4 text-lg text-gray-600 leading-7 font-semibold"><a href="{{ url('NE_atostogos') }}">Neapmokamos atostogos</a></div>
        </div>

        <div class="ml-12">
            <div class="mt-2 text-sm text-gray-500">
                Nemokamų atostogų prašymo/įsakymo dokumentų generavimas.
            </div>
            <a href="{{ url('NE_atostogos') }}">
                <div class="mt-3 flex items-center text-sm font-semibold text-indigo-700">
                        <div>Pildyti paraišką</div>
    ...
    <div class="p-6 border-t border-gray-200 md:border-l">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#808080" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="w-8 h-8 text-gray-400"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path><circle cx="12" cy="12" r="3"></circle></svg>
            <div class="ml-4 text-lg text-gray-600 leading-7 font-semibold"><a href="{{ url('vaiko_atostogos') }}">Vaiko priežiūros atostogos</a></div>
        </div>

        <div class="ml-12">
            <div class="mt-2 text-sm text-gray-500">
                Vaiko priežiūros atostogų, prašymo/įsakymo dokumentų generavimas.
            </div>
            <a href="{{ url('vaiko_atostogos') }}">
                <div class="mt-3 flex items-center text-sm font-semibold text-indigo-700">
                        <div>Pildyti paraišką</div>
    ...
    <div class="p-6 border-t border-gray-200 md:border-l">
        ...
        <div class="ml-12">
            <div class="mt-2 text-sm text-gray-500">
                Pasiaiškinimo formos dokumento koregavimas.
            </div>
            <a href="{{ url('pravaikstos') }}">
                <div class="mt-3 flex items-center text-sm font-semibold text-indigo-700">
                        <div>Pildyti paraišką</div>
    ...
    <div class="p-6 border-t border-gray-200 md:border-l">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#808080" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="w-8 h-8 text-gray-400"><polyline points="1 4 1 10 7 10"></polyline><polyline points="23 20 23 14 17 14"></polyline><path d="M20.49 9A9 9 0 0 0 5.64 5.64L1 10m22 4l-4.64 4.36A9 9 0 0 1 3.51 15"></path></svg>
            <div class="ml-4 text-lg text-gray-600 leading-7 font-semibold"><a href="{{ url('komandiruote') }}">Komandiruotė</a></div>
        </div>

        <div class="ml-12">
            <div class="mt-2 text-sm text-gray-500">
                Komandiruotės įsakymo dokumento generavimas.
            </div>
            <a href="{{ url('komandiruote') }}">
                <div class="mt-3 flex items-center text-sm font-semibold text-indigo-700">
                        <div>Pildyti paraišką</div>
    ...
    <div class="p-6 border-t border-gray-200 md:border-l">
        <div class="flex items-center">
        <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#808080" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="w-8 h-8 text-gray-400"><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg>
            <div class="ml-4 text-lg text-gray-600 leading-7 font-semibold"><a href="{{ url('priedai') }}">Priedai</a></div>
        </div>

        <div class="ml-12">
            <div class="mt-2 text-sm text-gray-500">
                Priedų įsakymo dokumentų generavimas.
            </div>
            <a href="{{ url('priedai') }}">
                <div class="mt-3 flex items-center text-sm font-semibold text-indigo-700">
                        <div>Pildyti paraišką</div>
    ...
    <div class="p-6 border-t border-gray-200 md:border-l">
        <div class="flex items-center">
        <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#808080" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="w-8 h-8 text-gray-400"><path d="M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.77-3.77a6 6 0 0 1-7.94 7.94l-6.91 6.91a2.12 2.12 0 0 1-3-3l6.91-6.91a6 6 0 0 1 7.94-7.94l-3.76 3.76z"></path></svg>
            <div class="ml-4 text-lg text-gray-600 leading-7 font-semibold"><a href="{{ url('ds_keitimas') }}">Darbo sąlygų keitimas</a></div>
        </div>

        <div class="ml-12">
            <div class="mt-2 text-sm text-gray-500">
                Darbo sąlygų įsakymų ir darbo sutarties pakeitimų generavimas.
            </div>
            <a href="{{ url('ds_keitimas') }}">
                <div class="mt-3 flex items-center text-sm font-semibold text-indigo-700">
                        <div>Pildyti paraišką</div>
